    ...
    public async Task SetUpDummyData()
    {
        if (!(await _takRepository.GetAllTakken()).Any())
        {
            var takken = new List<Tak>(){
                new Tak(){
                    TakId = Guid.NewGuid(), TakNaam = "Kapoenen"
                },
                new Tak(){
                    TakId = Guid.NewGuid(), TakNaam = "Welpen"
                },
                new Tak(){
                    TakId = Guid.NewGuid(), TakNaam = "Jongverkenners"
                },
                new Tak(){
                    TakId = Guid.NewGuid(), TakNaam = "Verkenners"
                },
                new Tak(){
                    TakId = Guid.NewGuid(), TakNaam = "JIN's"
                },
            };
